...
const ClimateDetailsComponent = ({detailsData}) => {
  return (
    <View style={{ marginTop: HEIGHT*0.03, paddingHorizontal: WIDTH*0.03 }}>
            ...
            colors={[setColors.climateShade1,setColors.climateShade2,setColors.climateShade3]}>   
...
export default ClimateDetailsComponent